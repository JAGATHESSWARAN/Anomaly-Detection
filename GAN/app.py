...
SMTP_PORT = 587
EMAIL_FROM = 'daminmain@gmail.com'  # Direct value instead of os.getenv
EMAIL_PASSWORD = 'kpqtxqskedcykwjz'  # Direct value instead of os.getenv
EMAIL_TO = 'jagathesswaranvadivel@gmail.com'  # Receiver's email
